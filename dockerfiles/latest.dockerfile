...
#RUN apt update && apt-get install libfftw3-single3
#RUN mv /root/fftw-build/3.3.8-shared-gcc840-avx2-broadwell/lib/libfftw3f.so.3.5.7 /usr/lib/x86_64-linux-gnu
